...
public interface ImageTabRepository extends JpaRepository<ImageTab, Long> {
	...
	Optional<ImageTab> findFirstImageByStudyKeyAndSeriesKey(@Param("studyKey") Long studyKey, @Param("seriesKey") Long seriesKey);
	
	ImageTab findFirstBySeriesKeyAndCurSeqNum(Long seriesKey, long curSeqNum);
	}