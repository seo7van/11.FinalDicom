...
public interface StudyTabRepository extends JpaRepository<StudyTab, Long> {
    ...
    // studyDate로 명시적인 JPQL 쿼리 사용
//    @Query("SELECT s FROM StudyTab s WHERE s.studyDate = :studyDate")
//    List<StudyTab> findByStudyDate(@Param("studyDate") String studyDate);
//    List<StudyTab> findByStudyDate(String studyDate);
